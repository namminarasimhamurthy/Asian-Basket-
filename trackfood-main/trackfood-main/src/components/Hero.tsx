...
//     subtitle: "Authentic Taste of India",
//     description:
//       "Get the finest long-grain rice for your biryani and pulao.",
//     image:
...
//     subtitle: "Premium Quality Cuts",
//     description:
//       "Fresh chicken, lamb, and beef sourced from trusted farms.",
//     image:
...
// const Hero = () => {
//   const [currentSlide, setCurrentSlide] = useState(0);
//   const [validSlugs, setValidSlugs] = useState<string[]>([]);
...
//       .then((res) => {
//         setValidSlugs(res.data.map((cat: any) => cat.slug));
//       })
//       .catch(() => setValidSlugs([]));
//   }, []);
...
//               <div className="flex gap-4">
//                 {validSlugs.includes(slide.categorySlug) && (
//                   <Link to={`/category/${slide.categorySlug}`}>
//                     <Button
//                       size="lg"
