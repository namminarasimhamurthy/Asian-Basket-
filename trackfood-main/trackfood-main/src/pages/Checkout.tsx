...
// import { useNavigate, Link } from 'react-router-dom';
// import {
//   ArrowLeft, ShoppingBag, MapPin, CreditCard, Loader2,
//   Tag, Ticket, AlertTriangle, Package
// } from 'lucide-react';
// import { useForm, useWatch } from 'react-hook-form';
// import { zodResolver } from '@hookform/resolvers/zod';
// import { z } from 'zod';
...
//       setVoucherCode('');
//     } catch (err: any) {
//       setVoucherError(err?.response?.data?.error || 'Invalid promo code');
//     }
//   };
...
//       <FrozenItemAlert
//         isOpen={showFrozenAlert}
//         onProceed={() => setShowFrozenAlert(false)}
//         onModify={() => navigate('/')}
//       />
//     </div>
//   );
